...
function populateOptions()
{
	...
	{
		optionsDiv = document.getElementById("opcoes-bootstrap");
		...
		for(var i = 0; i<options.length;i++)
		{
			...
			optionsDiv.innerHTML += "			<div id=\""+id+"\" class=\"opcao card\" style=\"width: 18rem; margin:5px\">"+
			"				<div class=\"card-body\">"+
...
function copyToClipboard() {
	var input = document.getElementById("entrada-transformada");
	input.select();
